# -*- coding: utf-8 -*-
"""
Experiments for resilience of UNets with foreground ratios for Spleen MSD data.
"""
...
def main(input_image_size, root_dir):
    ...
    wandb_run = wandb.init(
        project="MONAI_Spleen_3D_Segmentation_UNETR",
        config=config,
    ...
    model_artifact = wandb.Artifact(
        "UNETR",
        type="model",
        description="UNETR for 3D Segmentation of spleen",
