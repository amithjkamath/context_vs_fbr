# -*- coding: utf-8 -*-
"""
Synthetic data experiments for resilience of AttentionUnets with foreground ratios.
"""
...
def main(input_image_size):
    ...
    wandb_run = wandb.init(
        project="MONAI_Synthetic_3D_Segmentation_AttentionUnet",
        config=config,
    ...
    model_artifact = wandb.Artifact(
        "AttentionUnet",
        type="model",
        description="AttentionUnet for 3D Segmentation of synthetic data",
