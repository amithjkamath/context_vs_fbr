# -*- coding: utf-8 -*-
"""
Synthetic data experiments for resilience of UNETR with foreground ratios.
"""
...
def main(input_image_size):
    ...
    config = {
        ...
        # UNETR Model
        "model_type": "UNETR",  # just to keep track
        "model_params": dict(
            in_channels=1,
            out_channels=2,
            img_size=(input_image_size, input_image_size, input_image_size),
            feature_size=16,
            hidden_size=768,
            mlp_dim=3072,
            num_heads=12,
    ...
    wandb_run = wandb.init(
        project="MONAI_Synthetic_3D_Segmentation_UNETR",
        config=config,
    ...
    # standard PyTorch program style: create UNETR, DiceLoss and Adam optimizer
    ...
    model_artifact = wandb.Artifact(
        "UNETR",
        type="model",
        description="UNETR for 3D Segmentation of synthetic data",
